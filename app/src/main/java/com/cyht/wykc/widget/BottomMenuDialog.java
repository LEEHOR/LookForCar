...
public class BottomMenuDialog extends Dialog {
    ...
    public static class Builder {
        ...
        public Builder addMenu(String text, OnBottomMenuClickListener listener) {
            BottomMenu bm = new BottomMenu(text, listener);
            this.p.menuList.add(bm);
            return this;
        }

        public Builder addMenu(int textId, OnBottomMenuClickListener listener) {
        ...
        public BottomMenuDialog create() {
            ...
            if (hasTitle) {
                ...
                tTitle.setTextColor(p.context.getResources().getColor(R.color.cyht_prompt_text_color));
            ...
            for (int i = 0; i < p.menuList.size(); i++) {
                ...
                bbm.setTextColor(p.context.getResources().getColor(R.color.font_blue_color));
                bbm.setTextSize(18);
                bbm.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        bottomMenu.listener.onClick();
                        dialog.dismiss();
                    }
                });
                ...
                if (i != p.menuList.size() - 1) {
                    View viewDivider = new View(p.context);
                    viewDivider.setLayoutParams(lpDivider);
                    viewDivider.setBackgroundColor(p.context.getResources().getColor(R.color.cyht_line_color));
                    layContainer.addView(viewDivider);
                }
            }
    ...
    private static class BottomMenu {
        ...
        public OnBottomMenuClickListener listener;

        public BottomMenu(String funName, OnBottomMenuClickListener listener) {

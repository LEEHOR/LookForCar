...
public class VideoListAdapter0 extends BaseQuickAdapter<CarMediaInfoBean.DataEntity.ZhizaoEntity,BaseViewHolder> {
    private CarVideoItemClickListener itemClickListener;
    public VideoListAdapter0() {
        super(R.layout.item_video_recycleview,null);
    }


    @Override
    protected void convert(BaseViewHolder helper, final CarMediaInfoBean.DataEntity.ZhizaoEntity item) {

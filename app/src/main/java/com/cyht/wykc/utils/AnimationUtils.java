...
public class AnimationUtils {
     ...
     */
    @SuppressLint("NewApi")
    public static void show(final View myView, float startRadius, long durationMills) {
    ...
    public static void startActivityFinish(
            final Activity thisActivity, final Intent intent, final View triggerView, int colorOrImageRes, long durationMills) {

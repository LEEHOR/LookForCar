...
public class VideoListAdapter4 extends BaseQuickAdapter<CarMediaInfoBean.DataEntity.GukeEntity,BaseViewHolder> {
    private CarVideoItemClickListener itemClickListener;
    public VideoListAdapter4() {
        super(R.layout.item_video_recycleview,null);
    }


    @Override
    protected void convert(BaseViewHolder helper,final CarMediaInfoBean.DataEntity.GukeEntity item) {

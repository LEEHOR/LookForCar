...
public class VideoListAdapter2 extends BaseQuickAdapter<CarMediaInfoBean.DataEntity.DongtaiEntity,BaseViewHolder> {
    private CarVideoItemClickListener itemClickListener;
    public VideoListAdapter2() {
        super(R.layout.item_video_recycleview,null);
    }


    @Override
    protected void convert(BaseViewHolder helper, final CarMediaInfoBean.DataEntity.DongtaiEntity item) {
        if (item != null) {

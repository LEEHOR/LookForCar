...
public class VideoListAdapter6 extends BaseQuickAdapter<CarMediaInfoBean.DataEntity.BaoyangEntity,BaseViewHolder> {
    private CarVideoItemClickListener itemClickListener;
    public VideoListAdapter6() {
        super(R.layout.item_video_recycleview,null);
    }


    @Override
    protected void convert(BaseViewHolder helper,final CarMediaInfoBean.DataEntity.BaoyangEntity item) {

package com.cyht.wykc.widget.LoadingDrawable;
...
public class CircleBroodLoadingRenderer extends LoadingRenderer {
    ...
    private final int DEFAULT_BACKGROUND_COLOR = Color.parseColor("#FFFFFFFF");
    private final int DEFAULT_BACKGROUND_DEEP_COLOR = Color.parseColor("#FFFFFFFF");
    ...
    private void init(Context context) {
        mWidth = DensityUtils.dp2px(context, DEFAULT_WIDTH);
        mHeight = DensityUtils.dp2px(context, DEFAULT_HEIGHT);

        mMaxMotherOvalSize = DensityUtils.dp2px(context, MAX_MATHER_OVAL_SIZE);
        mBasicChildOvalRadius =DensityUtils.dp2px(context, MIN_CHILD_OVAL_RADIUS);

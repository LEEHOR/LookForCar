...
import com.cyht.wykc.BuildConfig;
import com.cyht.wykc.common.Constants;
import com.cyht.wykc.utils.Configuration;
...
public class HttpHelper {
    ...
    private volatile static HttpHelper INSTANCE;  //volatile关键字描述的对象，取值时只在主内存中取，对象在每个线程中发生改变后，会把改变覆盖主内存
    ...
    //获取单例
    public static HttpHelper getInstance() {//dcl单例模式   双重判断
        if (INSTANCE == null) {

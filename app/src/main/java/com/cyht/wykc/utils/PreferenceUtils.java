...
public class PreferenceUtils {
     ...
     * modified:
     */
    public static void setPrefObject(Context context, String key, Object obj){
        try {
            // 保存对象
//            SharedPreferences.Editor sharedata = context.getSharedPreferences(FILENAME, 0).edit();
            ...
            //保存该16进制数组
            PreferenceUtils.setPrefString(context,key,bytesToHexString);
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
     ...
     * modified:
     */
    public static Object getPrefObject(Context context, String key){
        try {
                String string = PreferenceUtils.getPrefString(context,key,"");
    ...
    /**
     * desc:将16进制的数据转为数组
     * <p>创建人：聂旭阳 , 2014-5-25 上午11:08:xinshang</p>
     * @param data
     * @return
     * modified:
     */
